import pytest
from application.use_cases.category import CategoryUseCases
from application.database.models import Category as CategoryModel


from application.schemas.category import Category, CategoryOutput
